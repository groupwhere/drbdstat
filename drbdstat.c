 ...
 * (c)2012-2013 Miles Lott <mlott@gie.com>
 *
 ...
 *
 * $Id: drbdstat.c,v 1.6 2013/11/27 13:26:18 gulfconfig Exp $
 */
...
int main(void)
{
	...
	while(1)
	{
		...
		if(stat("/sys/module/drbd/initstate") > -1)
		{
